...
/**
 * Merupakan Class yang digunakan untuk memberikan request Accept pada Payment
 * @author Hanz Christian
 * @version 16 Desember 2021
 */

public class AcceptPaymentRequest extends StringRequest {
    private static final String ACCEPT_URL = "http://10.0.2.2:6969/payment/%d/accept";
    private final Map<String, String> params;

    /**
     * Merupakan Constructor request yang melakukan POST pada backend untuk accept berdasarkan parameter
